  ...
  implements IBrandingProduct
{
  ...
  public mainCategory!: string; // NEW FIELD
  public stockInfo!: { // NEW FIELD
  ...
  public isAvailable!: boolean; // NEW FIELD
    ...
    SupplierProduct.init(
      {
        ...
        stockInfo: {
          ...
          allowNull: true,
          get() {
            const rawValue = this.getDataValue("stockInfo") as any;
            return rawValue ? JSON.parse(rawValue) : null;
          },
          set(value: any) {
            this.setDataValue("stockInfo", JSON.stringify(value) as any);
          },
        },
        isAvailable: {
          type: DataTypes.BOOLEAN,

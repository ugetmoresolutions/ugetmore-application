          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4">
            {communications.length === 0 ? (
              <div className="text-center py-12 text-slate-500">
                ...
                <p>No messages yet</p>
                <p className="text-sm">
                  Start a conversation about this design
                </p>
              </div>
            ) : (
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                <textarea
                  ...
                  rows={2}
                  className="w-full px-3 py-2 border border-slate-300 rounded-full focus:ring-2 focus:ring-slate-900 focus:border-transparent resize-none text-sm"
                />
              ...
              <div className="flex items-center gap-2">
                {/* Attachment button */}
                <label className="p-2 bg-slate-100 hover:bg-slate-200 rounded-full cursor-pointer transition-colors">
                ...
                <button
                  ...
                  className="p-2 bg-slate-900 text-white hover:bg-slate-800 rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >

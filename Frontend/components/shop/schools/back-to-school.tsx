...
const BackToSchoolStationeryBanner = () => {
  ...
  return (
    <section className="relative mx-auto w-full h-[200px] mt-10  lg:max-w-7xl sm:h-[350px] md:h-[280px]  overflow-hidden ">
      {/* Slides Container */}
      ...
      <div className="absolute inset-0 flex items-center z-10">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-xl lg:max-w-2xl">
            ...
            <p className="text-white text-sm sm:text-base md:text-lg lg:text-xl mb-6 sm:mb-8 leading-relaxed">
              Get ready to start the new school year fully equipped! From notebooks<br className="hidden md:block" />
              to pens and art supplies — everything you need is just a click away.
            </p>
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full transition-all duration-300 ${
              index === currentSlide ? 'bg-white w-8 sm:w-10' : 'bg-white/50 hover:bg-white/75'
            }`}
